...
function greatestProduct(matrix) {
  // created 20 additional arrays that consist of all numbers in the different arrays that share the same index (20 new arrays, total of 40)
  ...
  // reduced every array to contain only the four highest numbers from its content
  let filteredArrays = [];
  ...
  //created a new array that contains the products of all filtered Arrays
  let highestProducts = [];
  ...
  //looked for the highest number in this array
